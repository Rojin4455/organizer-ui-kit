          ...
          <Table size="small">
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                <TableCell sx={{ fontWeight: 'bold', width: '40%' }}>Nature and Source</TableCell>
                <TableCell sx={{ fontWeight: 'bold', width: '30%' }}>Current Year Tax Payer</TableCell>
                <TableCell sx={{ fontWeight: 'bold', width: '30%' }}>Current Year Spouse</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              <TableRow>
                <TableCell>1. Alimony received</TableCell>
                <TableCell>
                  <TextField
                    value={data.alimonyReceivedTaxpayer || ''}
                    onChange={(e) => handleChange('alimonyReceivedTaxpayer', e.target.value)}
                    size="small"
                    fullWidth
                ...
                <TableCell>
                  <TextField
                    value={data.alimonyReceivedSpouse || ''}
                    onChange={(e) => handleChange('alimonyReceivedSpouse', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
              ...
              <TableRow>
                <TableCell>2. Jury duty pay</TableCell>
                <TableCell>
                  <TextField
                    value={data.juryDutyPayTaxpayer || ''}
                    onChange={(e) => handleChange('juryDutyPayTaxpayer', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
                ...
                <TableCell>
                  <TextField
                    value={data.juryDutyPaySpouse || ''}
                    onChange={(e) => handleChange('juryDutyPaySpouse', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
              ...
              <TableRow>
                <TableCell>3. Prizes, Bonuses, Awards</TableCell>
                <TableCell>
                  <TextField
                    value={data.prizesAndAwardsTaxpayer || ''}
                    onChange={(e) => handleChange('prizesAndAwardsTaxpayer', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
                ...
                <TableCell>
                  <TextField
                    value={data.prizesAndAwardsSpouse || ''}
                    onChange={(e) => handleChange('prizesAndAwardsSpouse', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
              ...
              <TableRow>
                <TableCell>4. Investment Interest</TableCell>
                <TableCell>
                  <TextField
                    value={data.investmentInterestTaxpayer || ''}
                    onChange={(e) => handleChange('investmentInterestTaxpayer', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
                ...
                <TableCell>
                  <TextField
                    value={data.investmentInterestSpouse || ''}
                    onChange={(e) => handleChange('investmentInterestSpouse', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
              ...
              <TableRow>
                <TableCell>5. Other</TableCell>
                <TableCell>
                  <TextField
                    value={data.otherIncome1Taxpayer || ''}
                    onChange={(e) => handleChange('otherIncome1Taxpayer', e.target.value)}
                    size="small"
                    fullWidth
                    InputProps={{ startAdornment: '$' }}
                  />
